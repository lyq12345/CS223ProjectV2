...
import cs223.group8.session.FollowerOneSessionConfig;
...
public class FollowerOneDatasourceRepository {
    public Integer readItemValue(String key) {
        SqlSession session = FollowerOneSessionConfig.sqlSession;
    ...
    public void SynchronizeWithLeader(String entry) {
        LogParser logParser = new LogParser("src/main/java/cs223/group8/logs/follower1_log.txt");
        // write ahead log
